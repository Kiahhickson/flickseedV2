...
class FoundersControllerTest < ActionController::TestCase
  ...
  test "should create founder" do
    assert_difference('Founder.count') do
      post :create, founder: { capital_required: @founder.capital_required, company_name: @founder.company_name, description: @founder.description, email_address: @founder.email_address, equity_share: @founder.equity_share, image_four: @founder.image_four, image_one: @founder.image_one, image_three: @founder.image_three, image_two: @founder.image_two, industry: @founder.industry, name: @founder.name, password_digest: @founder.password_digest, profile_picture: @founder.profile_picture, user_id: @founder.user_id, video: @founder.video, website: @founder.website }
    end
